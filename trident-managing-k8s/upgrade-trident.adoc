...
`tridentctl`은 Astra Trident를 설치하는 기존 방법이며 복잡한 맞춤 설정이 필요한 사용자에게 가장 많은 옵션을 제공합니다. 자세한 내용은 link:../trident-get-started/kubernetes-deploy.html#choose-your-installation-method["설치 방법을 선택합니다"]을 참조하십시오.
